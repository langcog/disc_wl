...
\begin{figure}
  \begin{center} 
    ...
    \caption{\label{fig:toys} The four pairs of toys used in Experiments 1 and 2. Each toy had a unique affordance. For example, the lid in the upper left hand corner could be popped open and closed or the spaghetti sizer in the upper right photo could be irised open and shut.} 
  \end{center} 
\end{figure}
